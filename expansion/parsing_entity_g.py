...
entities=[]
with open('./data/SPACY_cand_g_twitter.txt','r') as f:
...
with open('./all_train_sentences/g_train.txt','r') as f:
    texts=[]
    tags=[]
    line=f.readline()
    temp_words=[]
...
with open('train_twitter_g_sentences.txt','w') as f:
    for i in range(len(texts)):
        f.write(texts[i]+'\n')
f.close()

with open('train_twitter_g_tags.txt','w') as f:
