...
`expansion/Bert_conll_expansian.py`  does similar job as `SPACY_expansion.py` besides using Bert embeddings rather than spaCy. Similarly, `phrase_lists_path` , `dict_path` , `candidate_path` variables at the top of the script can be modified. 
